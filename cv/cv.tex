...
\begin{minipage}[t]{.5\textwidth}
\raggedleft
\href{mailto:marko.cvjetko1@gmail.com}{\textcolor{blue}{marko.cvjetko1@gmail.com}} \\
...
I am a second-year PhD student in the FLOWERS team (Inria) building AI scientists that autonomously formulate goals, run experiments, and discover or control self-organizing phenomena in complex systems. My work combines curiosity-driven RL, evolutionary search, and vision--language models. I am extending this program in two directions: integrating LLMs more deeply as discovery partners in the experimental loop, and testing these methods on more biologically grounded substrates through ongoing collaboration with the \href{https://drmichaellevin.org/}{\textcolor{blue}{Levin Lab}} (Tufts). I am a 2026 \href{https://diverseintelligencesummer.com/}{\textcolor{blue}{DISI}} fellow and will visit \href{https://www.epfl.ch/labs/csft/}{\textcolor{blue}{Cl\'{e}ment Hongler's group}} at EPFL in May 2026.
\vspace{0.4em}
...
\begin{description}[leftmargin=1.5em, style=unboxed, font=\normalfont\bfseries, itemsep=0.4em, parsep=0em, topsep=0.2em]
    ...
    \hangindent=1em \textbf{Exploring Flow-Lenia Universes with a Curiosity-driven AI Scientist: Discovering Diverse Ecosystem Dynamics.} T. Michel$^{*}$, \underline{M. Cvjetko}$^{*}$, G. Hamon, P.-Y. Oudeyer, C. Moulin-Frier. In \textit{Proc. ALIFE 2025}, pp. 633--643. \href{https://doi.org/10.1162/ISAL.a.896}{\textcolor{blue}{doi:10.1162/ISAL.a.896}}. \textit{Population-based diversity search (IMGEPs) over system-wide complexity and evolutionary-activity metrics, surfacing ecosystem-level dynamics in Flow-Lenia.}\\[0.3em]
    \hangindent=1em \textbf{Expedition \& Expansion: Leveraging Semantic Representations for Goal-Directed Exploration in Continuous Cellular Automata.} S. Khajehabdollahi, G. Hamon, \underline{M. Cvjetko}, P.-Y. Oudeyer, C. Moulin-Frier, C. Colas. In \textit{Proc. ALIFE 2025}, pp. 73. \href{https://direct.mit.edu/isal/proceedings/isal2025/37/73/134068}{\textcolor{blue}{doi:10.1162/ISAL}}. \textit{Hybrid exploration alternating novelty search with VLM-generated linguistic goals, providing evidence that LLM-generated goals act as stepping stones into unexplored regions of the behavioral space.}
    \item[Late-breaking abstract] ~\\[0.2em]
    \hangindent=1em \textbf{Discovering and Controlling Diverse Self-Organised Patterns in Cellular Automata Using Autotelic Reinforcement Learning.} \underline{M. Cvjetko}, G. Hamon, C. Moulin-Frier, P.-Y. Oudeyer. \textit{ALIFE 2025}, Kyoto, Japan. \href{https://hal.science/hal-05399881v1/document}{\textcolor{blue}{[HAL]}}
    \item[Workshop report] ~\\[0.2em]
    \hangindent=1em \textbf{Evolving Symbiosis, from Barricelli's Legacy to Collective Intelligence: a Simulated and Conceptual Approach.} J. Ashford, \underline{M. Cvjetko}, R. L\"{o}ffler, B. Sakallioglu, A. Valerio, M. Tataryn, B. Hartl, L. Pio-Lopez, S. Nichele. \href{https://aliceworkshop.org/}{\textcolor{blue}{\textit{ALICE 2026 Workshop}}}, Copenhagen. \textbf{Runner-up award.} \href{https://arxiv.org/abs/2603.08463}{\textcolor{blue}{arXiv:2603.08463}}
\end{description}
...
\begin{period}{\textbf{\href{https://diverseintelligencesummer.com/}{\textcolor{blue}{Diverse Intelligences Summer Institute (DISI) Fellow}}}}{June 2026}
    \item Selected for the 3-week residential program in the Finger Lakes region of New York; cohort of $\sim$40 fellows funded by the John Templeton Foundation.
\end{period}
...
\begin{period}{\textbf{\href{https://aliceworkshop.org/}{\textcolor{blue}{ALICE Workshop}} Runner-up Award, Copenhagen}}{2026}
    \item Awarded for ``Evolving Symbiosis, from Barricelli's Legacy to Collective Intelligence''.
\end{period}

\begin{period}{\textbf{Invited journal extension, \textit{Artificial Life} special issue}}{2025}
    \item ALIFE 2025 paper invited for the \textit{Artificial Life} journal special issue, which will publish $\sim$5--8 papers selected from top-ranked submissions and best-paper nominees (91 papers accepted at the conference).
\end{period}
...
\section{skills}
\begin{skills}
    \textbf{Programming} & Python (Jax, PyTorch, NumPy, Transformers, Optuna), Java, C, Bash \\
    \\
