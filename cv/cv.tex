...
\begin{period}{\textbf{\href{https://disi.org/}{\textcolor{blue}{Diverse Intelligences Summer Institute (DISI) Fellow}}}}{June 2026}
...
\section{skills}
\begin{skills}
    \textbf{Programming} & Python, C, Bash \\
    \\
    \textbf{ML / DL} & PyTorch, JAX, NumPy, Hugging Face Transformers, Optuna \\
    \\
    \textbf{Reinforcement learning} & Stable-Baselines3, CleanRL \\
    \\
    \textbf{Evolutionary / QD search} & QDax \\
    \\
    \textbf{LLM / VLM serving} & vLLM \\
    \\
    \textbf{HPC} & Slurm, Singularity (parallel multi-node, multi-GPU workers, asynchronous coordination) \\
    \\
    \textbf{Tooling} & Linux, Docker, Git, LaTeX \\
    \\
